...
def evaluate_conv(args, unique_entities):
    ...
    with torch.no_grad():
        ...
        print("\nTest:")
        print("valid_MR: ",test_mean_rank)
        print("valid_MRR: ",test_mean_recip_rank)
        print("valid_Hits@1: ",test_hits_one)
        print("valid_Hits@3: ",test_hits_three)
        print("valid_Hits@10: ",test_hits_ten)
